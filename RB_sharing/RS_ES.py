...
config = 16 # 16 is small size, 80 is medium size, 200 is realistic size
uncorr = 0 # correlated case and uncorrelated case
loose_sla = 1 # Loose SLA or tight SLA
...
total_time = 0
action_rbg_slice = np.zeros((Num_tti, Num_RBG), dtype=int)
...
for tti in range (0, total_tti):
    ...
    # New RB 
        ...
        H_t = H[:,:, tti, sel_rbg]
        action_rbg_slice[tti,rbg], _, _ = choose_action(UE_list, H_t, SEL_UE, Num_UE)

...
for tti in range (0, total_tti):
    ...
    # New RB 
        ...
        #     avg_cb_rb_slice[:, sl] = avg_cb_rb_slice[:,sl] * jfi[sl]
        ...
        cg_user = np.divide(cg_rb_ue[sel_rbg,sel_sl*Num_UE_ps:(sel_sl+1)*Num_UE_ps], rt_history[sel_sl*Num_UE_ps:(sel_sl+1)*Num_UE_ps])
        # print(cg_rb_ue)
